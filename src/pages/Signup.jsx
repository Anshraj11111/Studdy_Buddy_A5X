        ...
        <div className="rounded-2xl p-8 relative overflow-hidden" style={{ 
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              {/* Full Name */}
              <div>
                <label className="block text-sm font-medium mb-1.5 text-theme-secondary">Full Name</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 text-theme-tertiary" size={18} />
                  <input
                    type="text"
                    name="name"
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-theme-primary placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition text-sm"
                  />
                </div>
                {errors.name && (
              ...
              {/* Email */}
              <div>
                <label className="block text-sm font-medium mb-1.5 text-theme-secondary">Email</label>
                <div className="relative">
              ...
              {/* Password */}
              <div>
                <label className="block text-sm font-medium mb-1.5 text-theme-secondary">Password</label>
                <div className="relative">
              ...
              {/* Confirm Password */}
              <div>
                <label className="block text-sm font-medium mb-1.5 text-theme-secondary">Confirm Password</label>
                <div className="relative">
                  <Shield className="absolute left-3 top-1/2 -translate-y-1/2 text-theme-tertiary" size={18} />
                  <input
                    type="password"
              ...
              {/* Role */}
              <div>
                <label className="block text-sm font-medium mb-1.5 text-theme-secondary">I am a</label>
                <div className="relative">
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-theme-primary focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition appearance-none cursor-pointer text-sm"
                  >
              ...
              <AnimatePresence>
                {formData.role === 'mentor' && (
                  ...
                  >
                    {/* Mentor Code */}
                    <div>
                      <label className="block text-sm font-medium mb-1.5 text-theme-secondary">Mentor Code</label>
                      <input
                        type="text"
                        name="mentorCode"
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-theme-primary placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition text-sm"
                      />
                      {errors.mentorCode && (
                        <p className="text-red-400 text-xs mt-1 flex items-center gap-1">
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-1.5 text-theme-secondary">
                        ...
                        <span className="text-theme-muted font-normal ml-1 text-xs">(select all that apply)</span>
                      </label>
                      ...
                      {formData.skills.length === 0 && (
                        <p className="text-xs text-theme-muted mt-1">Select at least one area of expertise</p>
                      )}
                    </div>
                  </motion.div>
                )}
              ...
              <motion.button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-theme-primary font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-purple-500/30 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
              ...
              <div className="mb-4">
                ...
                {googleLoading && (
                  <div className="flex items-center justify-center gap-2 mt-2">
                    ...
                    <span className="text-xs text-theme-tertiary">Signing up with Google...</span>
                  </div>
                )}
              </div>
